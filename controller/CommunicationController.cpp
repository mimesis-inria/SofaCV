...
#ifdef SOFA_WITH_DOUBLE
template class SOFA_SOFAORCOMMON_API CommunicationController<double>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Vec3d>>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Vec1d>>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Rigid3dTypes::Coord>>;
#endif
#ifdef SOFA_WITH_FLOAT
template class SOFA_SOFAORCOMMON_API CommunicationController<float>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Vec3f>>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Vec1f>>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Rigid3fTypes::Coord>>;
#endif
template class SOFA_SOFAORCOMMON_API CommunicationController<int>;
template class SOFA_SOFAORCOMMON_API CommunicationController<unsigned int>;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Vec<2,int>> >;
template class SOFA_SOFAORCOMMON_API CommunicationController<vector<Vec<2,unsigned>> >;
